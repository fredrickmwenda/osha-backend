    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <router-link :to="{ name: 'expenses.create' }" class="btn btn-primary btn-sm btn-flat">Add</router-link>
            ...
            <div class="panel-body">
                <b-table striped hover bordered :items="expenses.data" :fields="fields" show-empty>
                    <template v-slot:cell(status)="row">
                        <span class="label label-success" v-if="row.item.status == 1">Received</span>
                        <span class="label label-warning" v-else-if="row.item.status == 0">Processed</span>
