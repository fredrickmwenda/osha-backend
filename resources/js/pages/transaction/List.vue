        ...
        <div class="panel">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <div class="row">
                        <!-- FORM FOR FILTER BASED ON STATUS -->
                        <div class="col-md-6">
                            <select
            ...
            <div class="panel-body">
                <!-- AS BEFORE, THIS TABLE WILL SHOW TRANSACTION DATA -->
                <!-- THE EXPLANATION IS THE SAME AS THE PREVIOUS EXPLANATION -->
                <b-table
                    striped
                    hover
                    bordered
                ...
                >
                    <template v-slot:cell(customer)="row">
                        <p>
                            <strong>{{
                                row.item.customer ? row.item.customer.name : ""
                            }}</strong>
                        </p>
                        <p>Phone Number: {{ row.item.customer.phone }}</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p v-if="transactions.data">
                            ...
                            {{ transactions.data.length }} item dari
                            {{ transactions.meta.total }} total data
                        </p>
                    </div>
                    <div class="col-md-6">
                        <div class="pull-right">
